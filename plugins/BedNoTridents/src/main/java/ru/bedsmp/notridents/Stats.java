...
/** Счётчики очистки — показываются в /notridents stats. */
public final class Stats {
    ...
    private final AtomicLong enchantments = new AtomicLong();
    ...
    public void addEnchantment() { enchantments.incrementAndGet(); }
    ...
    public long enchantments() { return enchantments.get(); }
}
