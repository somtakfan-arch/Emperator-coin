...
HELP_COMMANDS = [
    ...
    (
        ...
        "<b>🎬 Медиа-команды</b>\n\n"
        "<b>.stik</b> — стикер из <b>фото</b> (обычный) или из <b>видео/кружка</b> "
        "(видео-стикер)\n"
        "<b>.gif</b> — видео → GIF (в ответ на видео)\n"
        "<b>.krom</b> — кружок из <b>видео</b> или из <b>фото</b>\n"
    ...
    (
        "ghost", "👁 /ghost",
        "<b>👁 Модуль /ghost</b>\n\nМгновенно помечает <b>все входящие</b> "
        "сообщения как «прочитано». Собеседник всегда видит прочтение сразу и "
        "не может понять, когда вы реально прочитали — настоящее время "
        "прочтения скрыто.\n\n"
        "<b>Как включить:</b> <code>/ghost on</code> "
