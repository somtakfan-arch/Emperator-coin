...
Config.Taser = {
    ...
    -- Дальность выстрела по машине. Через меню цель всё равно ищется в трёх
    -- метрах, так что это влияет только на стрельбу тазером.
    range = 22.0,

    -- Разряд по машине выкидывает того, кто за рулём, на асфальт. Ragdoll
    -- внутри салона игра не проигрывает, так что без этого тазер по водителю
    -- не делает вообще ничего.
    ejectFromVehicle = true,
}
