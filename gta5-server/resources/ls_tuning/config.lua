...
Config.Drive = {
    ...
    tiers = {
        { from = 3000000, kmh = 700.0, power = 480.0, torque = 4.0,
          grip = { traction = 1.95, damp = 2.4, spring = 0.55, gravity = 13.5 } },
        { from = 1000000, kmh = 450.0, power = 320.0, torque = 3.0,
          grip = { traction = 1.65, damp = 2.0, spring = 0.65, gravity = 12.0 } },
        { from = 300000,  kmh = 330.0, power = 200.0, torque = 2.2,
          grip = { traction = 1.35, damp = 1.6, spring = 0.80, gravity = 10.8 } },
        { from = 0,       kmh = 260.0, power = 140.0, torque = 1.8,
          grip = { traction = 1.15, damp = 1.3, spring = 0.90, gravity = 10.2 } },
    },
    ...
    defaultPower = 120.0,
    defaultTorque = 1.7,
    defaultGrip = { traction = 1.10, damp = 1.2, spring = 0.95, gravity = 10.0 },
